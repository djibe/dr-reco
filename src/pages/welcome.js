    ...
    <div class="grid-3">
      <div>
        <button class="dr-nav-card fade-up delay-1" data-target="windows">
          ...
          <p>Vérifier la version Windows, l'intégrité des fichiers système et la santé du disque.</p>
      ...
      <div>
        <button class="dr-nav-card fade-up delay-2" data-target="amelipro">
          ...
          <p>Diagnostiquer les pré-requis nécessaires à l'utilisation d'Amelipro et de la carte CPS.</p>
          <div class="dr-nav-card-arrow">→</div>
        </button>
      </div>
